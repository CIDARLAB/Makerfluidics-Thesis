...
Hippo \cite{becker2008} \cite{amin2009} Please \cite{duncan2015} read \cite{zhang2009pmma} the short pointers below and on the subsequent pages; this will help
you \cite{zhang2009pmma}avoid frustrations when submitting the final dissertation to the library.
